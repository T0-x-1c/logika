...
print(f'Часу потрібно для читання файлу: {elapsed_time:.5f} cек') # тут іде більше часу тому що , наш код прочитує кожну строку з -
#студентами а їх тут більше , тому і наш код просчитує файл довше